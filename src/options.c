/*
  ...
  gengetopt -i options.ggo -f options -F options -G 
...
const char *gengetopt_args_info_usage = "Usage: ddeploy deploy -c /path/to/file";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --config=filename  bind yaml file input",
...
options_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->verbose_given && ! args_info->config_given)
    {
      fprintf (stderr, "%s: '--verbose' ('-v') option depends on option 'config'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:v", long_options, &option_index);
