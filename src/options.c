/*
  ...
  gengetopt -i options.ggo -f options -F options -a options -G 
...
const char *options_purpose = "";

const char *options_usage = "Usage: ddeploy -c file ";

const char *options_versiontext = "";

const char *options_description = "User Restricted Docker Setup";
...
const char *options_help[] = {
  ...
  "  -t, --test             test  (default=off)",
  "  -a, --apply            apply  (default=off)",
    0
};
...
static
void clear_given (struct options *args_info);
static
void clear_args (struct options *args_info);

static int
options_internal (int argc, char **argv, struct options *args_info,
...
void clear_args (struct options *args_info)
{
  ...
  args_info->apply_flag = 0;
  
}

static
void init_args_info(struct options *args_info)
{


  args_info->help_help = options_help[0] ;
  args_info->version_help = options_help[1] ;
  args_info->config_help = options_help[2] ;
  args_info->daemon_help = options_help[3] ;
  args_info->test_help = options_help[4] ;
  args_info->apply_help = options_help[5] ;
...
options_print_version (void)
{
  ...
  if (strlen(options_versiontext) > 0)
    printf("\n%s\n", options_versiontext);
}

static void print_help_common(void)
{
	size_t len_purpose = strlen(options_purpose);
	size_t len_usage = strlen(options_usage);
	...
	if (strlen(options_description) > 0) {
		printf("%s\n\n", options_description);
	}
}
...
options_print_help (void)
{
  int i = 0;
  print_help_common();
  while (options_help[i])
    printf("%s\n", options_help[i++]);
}

void
options_init (struct options *args_info)
{
...
static void
options_release (struct options *args_info)
{
...
int
options_dump(FILE *outfile, struct options *args_info)
{
  int i = 0;
  ...
  if (args_info->apply_given)
    write_into_file(outfile, "apply", 0, 0 );
...
int
options_file_save(const char *filename, struct options *args_info)
{
  FILE *outfile;
  int i = 0;
...
void
options_free (struct options *args_info)
{
...
int
options (int argc, char **argv, struct options *args_info)
{
  return options2 (argc, argv, args_info, 0, 1, 1);
}

int
options_ext (int argc, char **argv, struct options *args_info,
                   struct options_params *params)
{
  int result;
...
int
options2 (int argc, char **argv, struct options *args_info, int override, int initialize, int check_required)
{
  int result;
  struct options_params params;
...
int
options_required (struct options *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
...
int
options_internal (
  int argc, char **argv, struct options *args_info,
                        struct options_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct options local_args_info;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVc:dta", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* apply.  */
          ...
          if (update_arg((void *)&(args_info->apply_flag), 0, &(args_info->apply_given),
              &(local_args_info.apply_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "apply", 'a',
              additional_error))
            goto failure;
